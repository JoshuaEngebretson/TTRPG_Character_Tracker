...
const Character_Info = [Char_Name, Char_Race, Char_Class, CurrentHitPoints, MaxHitPoints, Armor_class];
...
function add_or_remove_hitPoints( Pos_or_Neg_HP_adjustment){
    ...
    else if ( Char_Info[3] < 0 && Character_Info[3] > -Character_Info[3]){
        if ( Char_Info[1] === 'Half-Orc' && Relentless_Endurance_Active === True || Character_Info[1] === 'Orc' && Relentless_Endurance_Active === true ) {
